...
<template>
  <div id = "databinding" style = "">
    ...
    <input type = "number" v-model.number = "amount" placeholder = "Enter Amount" @change="updateAmount"/><br/><br/>
    <span>Convert From:</span>
    <select v-model = "convertfrom" style = "width:300px;font-size:15px;" @change="event => this.$emit('changeCurrency', event)">
